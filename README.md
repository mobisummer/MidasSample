...
[![Download](https://api.bintray.com/packages/mobisummer/maven/midassdk/images/download.svg?version=1.1.6)](https://bintray.com/mobisummer/maven/midassdk/1.1.6/link)
...
```groovy
implementation 'com.ms:midassdk:1.1.6'
```
